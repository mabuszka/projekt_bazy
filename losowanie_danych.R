...
templatka_opisu <- c("Wspanialy wyjazd do city! Niewiarygodne prze≈ºycia gwarantowane. Zrelaksuj sie az liczba_dni dni. W ramach wyjazdu wiele niesamowitych atrakcji.")
...
numer_nowego_uczestnika<-n_klientow #do tego bÍdÍ dodawaÊ liczby jako kolejni uczestnicy nowi

for (k in unique(zamowienia_rand[,1])){ #przechodzÍ po klientach ktÛrzy sπ w jakimkolwiek zamowieniu jako kupujacy
...
# teraz trzeba znowu przeprowadzic losowanie klientow tylko zamiast n_klientow wpisaÊ ile_osob_dodac i dokleiÊ nowπ ramkÍ danych do tamtej
